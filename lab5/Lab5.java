...
// FILENAME: Lab5
// SPECIFICATION: Learning to use reusable loops to build rows, pyramids, and diamonds.
// FOR: CSE 110 <Class #15817> / <Fridays 9:05-9:55am>
...
public class Lab5 
{
    ...
    private static String buildDiamond(
        ...
        for (int numSpaces = numSymbols; numSpaces >= 1; numSpaces -= 2) {
            int numDashed = (numSymbols - numSpaces) / 2;
